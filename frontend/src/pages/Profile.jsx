...
export default function Profile() {
  ...
  const { contributions, fetchContributions, deleteContribution } = useProfileStore();
  ...
  return (
    <div className="space-y-6">
          ...
          <dl className="grid grid-cols-1 gap-4">
            ...
            <div>
              ...
              <dd className="mt-1 text-sm text-gray-900">{
                user.role === 4 ? 'Admin' :
                user.role === 3 ? 'Researcher' :
                user.role === 2 ? 'Member' : 'Visitor'
              }</dd>
            </div>
            <div>
              <dt className="text-sm font-medium text-gray-500">Total Points</dt>
              <dd className="mt-1 text-sm text-gray-900">{user.total_points}</dd>
            </div>
            <div>
      ...
      {user.role >= 3 && (
        <div className="bg-white shadow rounded-lg p-6">
          <h3 className="text-lg font-medium leading-6 text-gray-900 mb-4">Your Contributions</h3>
