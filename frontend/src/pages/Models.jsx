...
export default function Models() {
  ...
  // Set first model name as default if none selected
  useEffect(() => {
  ...
  // Filter active models by selected model name
  ...
  const handleDownload = async (model) => {
    ...
    try {
      ...
      link.download = `${model.model_name}_v${model.version}.json`;
  ...
  // Prepare chart data only for selected model
  const chartData = {
